...
namespace TarjanAndZewicksOptimalArrayRGrows{
    ...
    public :
        ...
        explicit StateFullReadReverseWithDeleteBlockIterator(TZA_index_t r_param, const std::vector<TZA_index_t>& block_type_to_count_map, std::vector<std::vector<T*>>& index_blocks_list,
